        ...
        <ScrollView style={styles.body}>
          <View style={styles.contentImage}>
            {this.state.membership == 'BLUE' && (
              <FastImage style={styles.imageTop} source={Membresias.BLUE} />
            )}
            {this.state.membership == 'GOLD' && (
              <FastImage style={styles.imageTop} source={Membresias.GOLD} />
            )}
            {this.state.membership == 'OPERA' && (
              <FastImage style={styles.imageTop} source={Membresias.OPERA} />
            )}
            {this.state.membership == 'PREMIUM' && (
              <FastImage style={styles.imageTop} source={Membresias.PREMIUM} />
            )}
          </View>
